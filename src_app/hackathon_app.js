...
class HackathonApp extends React.Component {
  ...
  render() {
    const { playC,play_C, playD, playE, playF, playG, playA } = this.state
    return (
      <View name='main-view' alignment={'center-center'}>
        {this.renderNormalKey({ localPosition: [0, 0, 0], title: 'C',onClick: this.onButtonClick2({ playC: false },{ playC: true }) })}
        {this.renderSpecialKey({ localPosition: [0.024, 0.075, 0], title: '', onClick: this.onButtonClick2({ play_C: false },{ play_C: true }) })}
